...
<body>
    ...
    <header class="header">
        ...
        >
            ...
            <img
                src="/lojacosmeticos_alalet/public/assets/img/cherry3.png"
                alt="Cherry Make"
            >
                ...
                <?php foreach ($produtos as $produto): ?>
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-image">
                            ...
                            <img
                                src="/lojacosmeticos_alalet/<?= htmlspecialchars($produto['imagem']) ?>"
                        ...
                        <div class="price">
                            ...
                            R$ <?= htmlspecialchars($produto['preco']) ?>
                        ...
                        <button
                            ...
                            onclick="adicionarCarrinho(
                                ...
                                '<?= htmlspecialchars($produto['preco'], ENT_QUOTES) ?>',
                                '/lojacosmeticos_alalet/<?= htmlspecialchars($produto['imagem'], ENT_QUOTES) ?>'
                            )"
                        >
